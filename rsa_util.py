...
class RsaUtil(object):
    ...
    """
    PUBLIC_KEY_PATH = '../rsa/rsa_public_key.pem'  # 公钥
    PRIVATE_KEY_PATH = '../rsa/rsa_private_key.pem'  # 私钥
    ...
    def verify_by_public_key(self, message, signature):
        ...
        return rsa.verify(message.encode(), signature, self.company_public_key)